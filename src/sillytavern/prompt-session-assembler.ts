...
const EPHEMERAL_PLACEHOLDER_RE =
  /^(?:USER_INPUT|RANDOM_EVENTS|COMMISSIONS|TALENT|NARRATIVE_INTENTS|RECENT_COMBAT|AGENT\.[A-Z_]+|CHAR_GEN_RESULT|CRAFT_RESULT|CRAFT_REQUEST|CHAR_DETECT|ITEM_REQUEST|IMAGE_REQUEST|COMBAT_BRIEF|COMBAT_ROSTER|PLOT_THREAD_TURN|PLOT_THREAD_SURFACE)$/;
